      ...
      <Formik
        ...
        onSubmit={async values => {
          if (props.type === 'update') {
            ...
            await editInfraMerchant(props, values);
          } else {
            values.bank_id = props.bankId;
            await createInfraMerchant(props, values);
          }
        }}
      ...
      >
        {formikProps => {
          ...
          const fileUpload = (file, key) => {
            ...
            let url = `${API_URL}/${method}?token=${token}&from=infra`;
...
export default InfraCreateMerchantPopup;
