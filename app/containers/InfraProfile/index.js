            ...
            <Card bigPadding bordered>
              <div className="cardBody">
                <Row>
                  ...
                  <Col className="infoRight">{this.state.profile.name}</Col>
                </Row>

                <Row>
                  <Col className="infoLeft">User Id</Col>
                  <Col className="infoRight">{this.state.profile.username}</Col>
                </Row>
                ...
                <Row>
                  ...
                  <Col className="infoRight">{this.state.profile.email}</Col>
                </Row>
              </div>
            </Card>
          </Main>
