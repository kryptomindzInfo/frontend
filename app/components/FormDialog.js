  ...
  return (
    <Fragment>
      ...
      <Dialog
        ...
        classes={{ paper: user ? classes.dialogPaperLarge : classes.dialogPaperSmall }}
      >
          ...
          onSubmit={values => {
              ...
              user ? axios.post(
                ...
                if (res.data.error) {
                  ...
                  const { mobile } = JSON.parse(localStorage.getItem('userEditable'));
                  axios.post(
                    `${API_URL}/cashier/activateUser`,
                    { token, mobile },
                  ).then(r => {
                    if (res.data.error) {
                      throw res.data.error;
                  ...
                  <Grid item md={6} xs={12}>
                    ...
                    >
                      ...
                      <Paper variant="outlined" className={classes.dialogPaper}>
                          <Typography variant="headline">User Documents</Typography>
                      </Paper>
                      <Button
                        type="submit"
                        fullWidth
