...
class CashierSidebarInfo extends Component {
  editSignal = event => {
      this.props.edit();
  };
  blockSignal = event => {
  ...
  render() {
    ...
    return (
        <Sidebar marginRight>
            ...
            <A href={"/cashier/"+this.props.bankName+"/info"}>
            <Card rounded selected={info} className="sideNav">
                <i className="material-icons">person_add</i>
                <h3>Cashier Info</h3>
            </Card >
            </A>
            <A href={"/cashier/"+this.props.bankName+"/reports"}>
...
export default CashierSidebarInfo;
